...
This repository contains a **Retrieval-Augmented Generation (RAG) full-stack chatbot application** built with **Python, FastAPI, Redis, React and OpenAI's GPT-4o.** The chatbot specializes in answering questions about several topics that are handled when dealing with refugees. It is an advisory tool and does not give instructions for employees. It is here to help and not to instruct.
